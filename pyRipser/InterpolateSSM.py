...
def interpolateSSM(D, NIters):
    ...
    for i in range(NIters):
        ...
        DRet = f(xx, xx)
        np.fill_diagonal(DRet, 0) #Diagonal is not necessarily zero
    return DRet

if __name__ == '__main__':
    T1 = 10 #The period of the sine in number of samples
