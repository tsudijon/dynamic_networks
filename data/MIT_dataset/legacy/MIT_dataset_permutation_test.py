...
for i in range(num_perm):
    ...
    plt.savefig('/Users/biraj/Desktop/Presentations/figures/perm_MIT_%d.png' % i)

mp = np.array(mp)
large_mp = mp[mp > 28]
percentage = len(large_mp) / num_perm
print('Chance of getting mp larger than data is %0.2f' % percentage)
